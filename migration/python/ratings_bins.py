...
df_neighbors = pd.read_csv("neighbors-k-books.csv", sep=";", encoding="ISO-8859-1")
cols = df_neighbors.columns.difference(['Unnamed: 0'])

d = (df_neighbors.groupby('Unnamed: 0')[cols]
